...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/permission/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/permission/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/permission/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/permission/ip | grep $MYIP | awk '{print $3}')
fi
clear
echo -e "\e[36m╒════════════════════════════════════════════╕\033[0m"
...
serverV=$( curl -sS https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/versi)
...
curl -sS https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/clgshow
echo -e "
"
fi
echo -e "\e[36m╘═════════════════════════════════════════════╛\033[0m"
...
if [[ $(cat /opt/.ver) = $serverV ]] > /dev/null 2>&1; then
    ...
    if [[ $x -eq 69 ]]; then
       wget -q -O /usr/bin/update-script "https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/update.sh" && chmod +x /usr/bin/update
