...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/ssh1/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/daneshswara29/Xray-SSH/main/ssh1/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
